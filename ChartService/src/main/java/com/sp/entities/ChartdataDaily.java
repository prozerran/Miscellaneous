...
/**
 * The persistent class for the chartdata_daily database table.
 * 
 */
@Entity
@Table(name="chartdata_daily")
@NamedQuery(name="ChartdataDaily.findAll", query="SELECT c FROM ChartdataDaily c")
public class ChartdataDaily implements Serializable {

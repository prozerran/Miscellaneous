...
/**
 * The persistent class for the chartdata_minute database table.
 * 
 */
@Entity
@Table(name="chartdata_minute")
@NamedQuery(name="ChartdataMinute.findAll", query="SELECT c FROM ChartdataMinute c")
public class ChartdataMinute implements Serializable {

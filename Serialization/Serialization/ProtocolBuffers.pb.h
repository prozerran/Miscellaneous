...
#ifndef PROTOBUF_INCLUDED_ProtocolBuffers_2eproto
#define PROTOBUF_INCLUDED_ProtocolBuffers_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_ProtocolBuffers_2eproto 
...
class Person_PhoneNumber : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tutorial.Person.PhoneNumber) */ {
 ...
 private:
  ...
  int type_;
  friend struct ::protobuf_ProtocolBuffers_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
#endif  // PROTOBUF_INCLUDED_ProtocolBuffers_2eproto
